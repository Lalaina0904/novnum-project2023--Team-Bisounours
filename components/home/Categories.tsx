      ...
      <div className="container mx-auto mb-24">
        <div className="mb-32">
          <div className="flex flex-wrap">
            <div className="mb-10 w-full shrink-0 grow-0 basis-auto md:mb-0 md:w-6/12 md:pe-3 lg:pe-6">
            ...
            <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:mb-0 md:w-6/12 md:ps-3 lg:ps-6">
              <div className="fGUYkB relative px-4 py-8">
                ...
                <Btn
                  roundedMd={false}
                  btnClass="bg-[#f5b98a] text-white font-semibold uppercasesq"
                >
                  Find Resources
                </Btn>
              </div>
