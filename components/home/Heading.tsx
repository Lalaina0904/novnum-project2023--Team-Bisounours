...
export const Heading = () => {
  return (
    <header className="flex h-[85vh] flex-col items-center">
      <section className="container z-[1] mx-auto flex grow items-center px-2 md:py-[64px] lg:py-[96px]">
        <div className="w-full lg:w-2/3">
          <h1 className=" mb-8 text-[2.4rem] font-semibold leading-[3.6rem] md:text-[3rem]">
            <span className="title bg-gradient-to-r from-[#fab99b] via-[#c3aeff] to-[#7bb1e4]  bg-clip-text leading-[2rem] text-transparent">
              Explore a world{" "}
            </span>
        ...
        <div className="relative hidden h-full w-2/5 justify-center lg:flex">
          <Image
            className="heroImg absolute left-[4rem] top-[4rem]"
